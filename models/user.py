...
role_permission_table = db.Table("role_permission", db.Column("role_id", db.Integer, db.ForeignKey("role.id")),
...
class UserModel(db.Model):
    ...
    def check_password(self, raw_password):
        result = self.check_password_hash(self._password, raw_password)
        return result

    def has_permission(self, permission):
        return permission in [permission.name for permission in self.role]
